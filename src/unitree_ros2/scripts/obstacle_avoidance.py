...
class ObstacleAvoidance(Node):
    ...
    def _navigate_with_obstacle(self, front, left, right):
        ...
        # AJUSTEMENT 2 : Si l'obstacle passe sous 1.0m de distance, on applique l'angle maximum
        # pour forcer un évitement franc et dynamique avant de heurter l'objet
        if front < 1.0:
